# Exercício 001 — Multiplicação e Tipos Primitivos

* **Objetivo:** Ler dois números inteiros, realizar a multiplicação entre eles, exibir o resultado formatado e indicar o tipo primitivo retornado pela operação.
* **Conceito Aplicado:** Conversão com `int()`, f-strings e uso do comando `type()`.
