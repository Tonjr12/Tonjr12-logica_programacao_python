# Exercício 019 — Analisador de Texto

* **Objetivo:** Ler o nome completo de uma pessoa e exibir o nome em maiúsculas, minúsculas, o total de letras sem considerar espaços e quantas letras tem o primeiro nome.
* **Conceito Aplicado:** Métodos de string (`.strip()`, `.upper()`, `.lower()`, `.count()`, `.split()`), função `len()` e manipulação de listas.
