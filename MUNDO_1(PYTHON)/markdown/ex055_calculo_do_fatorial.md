# Exercício 055 — Cálculo do Fatorial

* **Objetivo:** Calcular o fatorial de um número inteiro informado pelo utilizador e exibir a sequência de multiplicações formatada na tela.
* **Conceito Aplicado:** Estrutura de repetição `while`, acumuladores de multiplicação (`f *= c`), decremento de contador (`c -= 1`) e operadores condicionais inline para formatação de texto.
